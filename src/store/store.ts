...
export const useShopStore = create<ShopState>(() => ({
    products: [
        { id: 1, name: 'Sneakers1', price: 120, stock: 10, discount: 50, photos:['../assets/image-product-1.jpg'] },
        { id: 2, name: 'Fall Limited Edition Sneakers', price: 25, stock: 5, discount: 15, photos:[] },
